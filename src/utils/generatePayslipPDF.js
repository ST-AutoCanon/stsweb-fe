...
const convertNumberToWords = (num) => {
  ...
  if (num === undefined || num === null || isNaN(num) || num < 0) return "Zero only";
...
const logoBase64  = "data:image/png;base64,";
  ...
  const earningsRows = [
    ...
    ["Other Allowances", `${getAmount(payrollData.other_allowances)}`, "ESIC", `${getAmount(payrollData.esic)}`],
    ["Incentives", `${getAmount(payrollData.incentives)}`, "Gratuity", `${getAmount(payrollData.gratuity)}`],
    ["Overtime", `${getAmount(payrollData.overtime)}`, "Professional Tax", `${getAmount(payrollData.professional_tax)}`],
    ["Statutory Bonus", `${getAmount(payrollData.statutory_bonus)}`, "TDS", `${getAmount(payrollData.tds)}`],
    ["Bonus", `${getAmount(payrollData.bonus)}`, "Insurance", `${getAmount(payrollData.insurance)}`],
    [`Gross Salary`, `${getAmount(payrollData.gross_salary)}`, `LOP Days: ${lopDays}`, `${getAmount(payrollData.lop_deduction)}`],
  ...
  doc.setFontSize(9).setFont("helvetica", "bold");
  doc.text("Company Contribution", margin + 10, finalY);
  ...
  autoTable(doc, {
    ...
    margin: { left: margin + 10, right: margin + 80 },
    tableWidth: 100,
  });
