...
if (
  ...
  console.log(`LTA Allowance (monthly, ${planData.ltaAllowance}% of basicSalary): ₹${ltaAllowance}`);
  ...
  console.log(`LTA Allowance (monthly, fixed amount): ₹${ltaAllowance}`);
} else {
  ltaAllowance = 0;
