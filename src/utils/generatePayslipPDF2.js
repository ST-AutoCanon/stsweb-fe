...
function generatePayslipPDF(
  ...
  if (!payrollData || !bankDetails || !attendance || !employeeDetails) {
  ...
  const formattedNetSalary = Math.round(netSalary);
...
const logoBase64  = "data:image/png;base64,";
  ...
  doc.text("Phone: +91 831 406 9203  Email: hr@sukalpatechsolutions.com", pageWidth - margin - 5, 34, { align: "right" });
  doc.setTextColor(0, 0, 0);

  // TITLE
  const monthName = new Date(0, selectedDate.month - 1).toLocaleString("default", { month: "long" });
  doc.setFontSize(14).setFont("helvetica", "bold");
  doc.text(`Payslip for ${monthName} ${selectedDate.year}`, pageWidth / 2, 60, { align: "center" });
  ...
  doc.setFontSize(9);
  // Left
  doc.setFont("helvetica", "bold").text("Employee Name:", 20, 75);
  doc.setFont("helvetica", "normal").text(getVal(payrollData.employee_name).toUpperCase().substring(0, 30), 60, 75);

  doc.setFont("helvetica", "bold").text("Gender:", 20, 82);
  doc.setFont("helvetica", "normal").text(getVal(employeeDetails.gender).toUpperCase(), 60, 82);

  doc.setFont("helvetica", "bold").text("Date of Joining:", 20, 89);
  doc.setFont("helvetica", "normal").text(getVal(payrollData.joining_date || employeeDetails.date_of_joining), 60, 89);

  doc.setFont("helvetica", "bold").text("Working Days:", 20, 96);
  doc.setFont("helvetica", "normal").text(String(attendance.total_working_days || "N/A"), 60, 96);

  doc.setFont("helvetica", "bold").text("UIN No:", 20, 103);
  doc.setFont("helvetica", "normal").text(getVal(payrollData.uin_number), 60, 103);

  doc.setFont("helvetica", "bold").text("ESI Number:", 20, 110);
  doc.setFont("helvetica", "normal").text(getVal(bankDetails.esi_number), 60, 110);

  // Right
  doc.setFont("helvetica", "bold").text("Employee ID:", 110, 75);
  doc.setFont("helvetica", "normal").text(getVal(payrollData.employee_id), 140, 75);

  doc.setFont("helvetica", "bold").text("Designation:", 110, 82);
  doc.setFont("helvetica", "normal").text(getVal(payrollData.designation).toUpperCase().substring(0, 25), 140, 82);

  doc.setFont("helvetica", "bold").text("Account No:", 110, 89);
  doc.setFont("helvetica", "normal").text(
    `${getVal(bankDetails.account_number)} ${bankDetails.bank_name ? `(${bankDetails.bank_name})` : ""}`.trim(),
    140,
    89
  );
  ...
  doc.setFont("helvetica", "normal").text(getVal(employeeDetails.pan_number), 140, 103);

  doc.setFont("helvetica", "bold").text("PF Number:", 110, 110);
  doc.setFont("helvetica", "normal").text(getVal(bankDetails.pf_number), 140, 110);

  // EARNINGS & DEDUCTIONS TABLE — ADVANCE & LOP REMOVED
  const getAmt = (val) => Math.round(parseFloat(val) || 0);

  const earnings = {
    basic: getAmt(payrollData.basic_salary),
    hra: getAmt(payrollData.hra),
    allowance: getAmt(payrollData.allowance || payrollData.other_allowance || 0),
  };

  const deductions = {
    pf: getAmt(payrollData.pf || 0),
    esi: getAmt(payrollData.esi || payrollData.esi_insurance || 0),
    pt: getAmt(payrollData.pt || payrollData.professional_tax || 0),
    tds: getAmt(payrollData.tds || 0),
  };

  const totalEarnings = earnings.basic + earnings.hra + earnings.allowance;
  const totalDeductions = deductions.pf + deductions.esi + deductions.pt + deductions.tds;

  const tableBody = [
    ["Basic Salary", earnings.basic.toString(), "PF (Employee)", deductions.pf.toString()],
    ["HRA", earnings.hra.toString(), "ESI", deductions.esi.toString()],
    ["Other Allowance", earnings.allowance.toString(), "Professional Tax", deductions.pt.toString()],
    ["", "", "TDS", deductions.tds.toString()],
    ["Gross Earnings", totalEarnings.toString(), "Total Deductions", totalDeductions.toString()],
  ];
  ...
  // ✅ SAME AS NET SALARY
  tableWidth: 100,
  margin: { left: margin + 10, right: margin - 5 },
  ...
  styles: {
    ...
    lineColor: [0, 0, 0],
    lineWidth: 0.1,
    cellPadding: { top: 3, bottom: 3, left: 3, right: 3 } // ✅ SAME compact look
  },
  ...
  // ✅ SAME PROPORTION AS NET SALARY (45 : 105 per side)
  columnStyles: {
    0: { cellWidth: 37.5, halign: "left" },
    1: { cellWidth: 37.5, halign: "right" },
    2: { cellWidth: 37.5, halign: "left" },
  ...
  // FOOTER
  doc.setFontSize(9);
  doc.text("This is a computer-generated payslip. No signature required.", margin + 10, doc.lastAutoTable.finalY + 15);

  const fileName = `Payslip_${payrollData.employee_id || "Employee"}_${monthName}${selectedDate.year}.pdf`;
