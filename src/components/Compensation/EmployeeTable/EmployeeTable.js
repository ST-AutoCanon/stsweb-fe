...
//   openAdvanceModal,
//   // openIncentiveModal,  // 🔹 Commented out if unused to avoid errors
//   showDetailsTab,
//   selectedEmployee,
//   activeTab,
//   setActiveTab,
...
//   overtimeRecords,
//   bonusRecords,
//   incentivesRecords,  // 🔹 Keep if needed elsewhere, but not for DetailsTab
//   advances,
//   employeeIncentiveData,  // 🔹 Added: Fixes no-undef error
// }) => {
...
//                       Add Advance
//                     </button>
//                     {/* <button  // 🔹 Commented if openIncentiveModal undefined
//                       className="sb-table-incentive-button"
//                       onClick={() => openIncentiveModal(emp.employee_id, emp.full_name)}
//                     >
//                       Add Incentive
//                     </button> */}
//                   </div>
...
//           advances={advances}
//           employeeIncentiveData={employeeIncentiveData}  // 🔹 Line ~291: Now defined via props
//           // incentivesRecords={incentivesRecords}  // 🔹 Remove if not used in DetailsTab
//         />
//       )}
//     </div>
//   );
...
// // import React from "react";
// // import { FaSearch } from "react-icons/fa";
// // import DetailsTab from "./../DetailsTab/DetailsTab"; // Adjust path if needed
// // import "./EmployeeTable.css";
...
// //   advances,
// // }) => {
// //   console.log("openIncentiveModal:", typeof openIncentiveModal); // Debug log
// //   const filteredEmployees = employees.filter(
// //     (emp) =>
// //       emp.employee_id.toString().toLowerCase().includes(searchQuery.toLowerCase()) ||
// //       emp.full_name.toLowerCase().includes(searchQuery.toLowerCase())
...
// //                 <td className="sb-table-cell sb-table-align-left">{emp.employee_id}</td>
// //                 <td className="sb-table-cell sb-table-align-left">{emp.full_name}</td>
// //  Knoxville                <td className="sb-table-cell sb-table-align-left">
// //                   {emp.compensation_plan_name || "No Plan Assigned"}
// //                 </td>
// //                 <td className="sb-table-cell sb-table-align-center">
// //                   <div className="sb-table-action-buttons">
