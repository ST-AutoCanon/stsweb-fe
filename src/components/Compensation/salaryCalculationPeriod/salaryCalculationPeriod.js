    ...
    <div className="salary-period-overlay">
      <div className="salary-period-modal">
        <div className="salary-period-header">
          <h2>
            {isEditing
              ? "Edit Salary Calculation Period"
              : "Add Salary Calculation Period"}
          </h2>
        ...
        <div className="salary-period-content">
              ...
              <div className="salary-period-form-group">
                ...
                <input
                  ...
                  className={`salary-period-input ${
                    errors.cutoff_date ? "error" : ""
                  }`}
                  required
                />
                {errors.cutoff_date && (
                  <span className="salary-period-error">
                    {errors.cutoff_date}
                  </span>
                )}
              </div>
              {errors.general && (
                <span className="salary-period-error general">
                  {errors.general}
                </span>
              )}
              <button
          ...
          <div className="salary-period-list-section">
            ...
            {periods.length === 0 ? (
              <p className="salary-period-no-data">
