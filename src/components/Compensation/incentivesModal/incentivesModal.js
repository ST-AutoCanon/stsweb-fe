...
const IncentivesModal = ({
  ...
  const validateForm = () => {
    ...
    if (
      ...
      !incentivesModal.ctcPercentage
    ) {
      setIncentivesModal({
        ...incentivesModal,
        error: "Enter CTC percentage.",
      });
      return false;
    }
    if (
      incentivesModal.incentiveType === "sales" &&
      !incentivesModal.salesAmount
    ) {
      setIncentivesModal({ ...incentivesModal, error: "Enter Sales amount." });
      return false;
    }
    if (
      !incentivesModal.applicableMonth ||
      incentivesModal.applicableMonth === "Select Month and Year"
    ) {
      setIncentivesModal({
        ...incentivesModal,
