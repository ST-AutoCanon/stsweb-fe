            ...
            <table className="esd-table">
              <thead>
                <tr>
                  ...
                  <th className="esd-table-header esd-align-right esd-scrollable">
                    LTA
                  </th>
                  <th className="esd-table-header esd-align-right esd-scrollable">
                    Other Allow.
                  ...
                  <th className="esd-table-header esd-align-right esd-scrollable esd-deduction">
                    Advance Rec.
                  </th>
                  <th className="esd-table-header esd-align-right esd-scrollable esd-deduction">
                    Emp. PF
              ...
              <tbody className="esd-table-body">
                {filteredEmployees.map((emp) => {
                  ...
                  const incentiveObj = matchedKey
                    ? employeeIncentiveData[matchedKey]
                    : null;
                  const incentiveValue = incentiveObj?.totalIncentive
                    ? parseFloat(incentiveObj.totalIncentive.value) || 0
                    : 0;
                  ...
                  return (
                    <tr key={emp.employee_id}>
                      ...
                      <td className="esd-table-cell esd-align-right">
                        {salaryDetails
                          ? `₹${parseFloat(salaryDetails.hra).toLocaleString()}`
                          : "N/A"}
                      </td>
                      ...
                      <td className="esd-table-cell esd-align-right esd-scrollable esd-deduction">
                        {salaryDetails
                          ? `₹${parseFloat(salaryDetails.tds).toLocaleString()}`
                          : "N/A"}
                      </td>
                      <td className="esd-table-cell esd-align-right esd-scrollable esd-deduction">
                        {salaryDetails
